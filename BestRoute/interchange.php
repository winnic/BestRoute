...
<html>
  <head>
	...
	<button type='button' class='edit' onclick='showNearby();' style="display:none">Show nearby stations</button>
...
//43->118
//425->313?StartindDistrict=德輔道西&StartingPoint=正街&DestinationPoint=小西灣?&DestinationDistrict=小西灣道
//50->330   ?StartindDistrict=上亞厘畢道&StartingPoint=香港禮賓府&DestinationPoint=洛陽街&DestinationDistrict=洛陽街
...
if(!JustWalk){
	...
	AjaxCall("", url, function (response){
			...
			document.getElementById("output").innerHTML="Origin="+SP_DP[0]["bus_stationCHI"]+" and Desination="+SP_DP[1]["bus_stationCHI"]+"<br>"+data;
		});
		}
},5000);
//show the best route
...
//	<button type='button' class='edit' onclick="function AAAAA(){document.getElementById('searchForm').style.display='block';};">Show search engine</button>	
 ...
 <div id="map-canvas" style="width: 100%; height: 570px" ></div>
