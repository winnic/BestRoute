<!DOCTYPE html >
  <head>
    ...
    //<![CDATA[
	 var start = new google.maps.LatLng(
              parseFloat(busInfo[0].lat),
              parseFloat(busInfo[0].longitube));
  var end = new google.maps.LatLng(
              parseFloat(busInfo[busInfo.length-1].lat),
              parseFloat(busInfo[busInfo.length-1].longitube));
	...
	//////////////////
		...
		///////creat waypoints///////////
		var numOfPoints=parseInt(busInfo.length/9+1);
  ...
  <body onload="load()">
    <div id="map" style="width: 800px; height: 450px; position: absolute; top:100px; right:30px;"></div>
  </body>
